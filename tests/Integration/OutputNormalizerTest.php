...
final class OutputNormalizerTest extends TestCase
{
    ...
    public static function outputProvider(): iterable
    {
        ...
        yield 'new 1ms with completion progress' => [
            <<<'OUTPUT'
                0 [>---------------------------]   0% < 1 ms 24.0 MiB
                2 [->--------------------------]  25% 1 s 24.0 MiB
                4 [--->------------------------]  75% 1 s 24.0 MiB
                ...
                OUTPUT,
            <<<'OUTPUT'
                0 [>---------------------------]   0% 10 secs 10.0 MiB
                2 [->--------------------------]  25% 10 secs 10.0 MiB
                4 [--->------------------------]  75% 10 secs 10.0 MiB
                5 [----->----------------------] 100% 10 secs 10.0 MiB
                OUTPUT,
        ];

        yield 'new 1ms and less than 1s with completion progress' => [
            <<<'OUTPUT'
                0/5 [>---------------------------]   0% < 1 ms/< 1 ms 24.0 MiB
                2/5 [===========>----------------]  40% < 1 ms/< 1 ms 24.0 MiB
                4/5 [======================>-----]  80% < 1 ms/< 1 ms 24.0 MiB
                5/5 [============================] 100%    1 s/1 s    24.0 MiB
                OUTPUT,
            <<<'OUTPUT'
                0/5 [>---------------------------]   0% 10 secs/10 secs 10.0 MiB
